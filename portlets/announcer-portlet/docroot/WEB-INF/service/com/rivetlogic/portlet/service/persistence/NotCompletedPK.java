 ...
 */
public class NotCompletedPK implements Comparable<NotCompletedPK>, Serializable {
	public String USER_ID;
	public String LAYOUT_PK;

	public NotCompletedPK() {
	}

	public NotCompletedPK(String USER_ID, String LAYOUT_PK) {
	...
	@Override
	public int compareTo(NotCompletedPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NotCompletedPK)) {
			return false;
		}

		NotCompletedPK pk = (NotCompletedPK)obj;
