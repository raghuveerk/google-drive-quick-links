...
/**
 * Provides the local service interface for Completed. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author charles.rodriguez
 * @see CompletedLocalServiceUtil
...
public interface CompletedLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompletedLocalServiceUtil} to access the completed local service. Add custom service methods to {@link com.rivetlogic.portlet.service.impl.CompletedLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
