...
/**
 * The base model implementation for the DriveLinks service. Represents a row in the &quot;rivetlogic_DriveLinks&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class DriveLinksModelImpl extends BaseModelImpl<DriveLinks>
	 ...
	 */
	public static final String TABLE_NAME = "rivetlogic_DriveLinks";
	public static final Object[][] TABLE_COLUMNS = {
			{ "USER_ID", Types.VARCHAR },
			{ "NAME", Types.VARCHAR },
			{ "URL", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table rivetlogic_DriveLinks (USER_ID VARCHAR(75) not null,NAME VARCHAR(75) not null,URL VARCHAR(150) null,primary key (USER_ID, NAME))";
	public static final String TABLE_SQL_DROP = "drop table rivetlogic_DriveLinks";
	public static final String ORDER_BY_JPQL = " ORDER BY driveLinks.id.USER_ID ASC, driveLinks.id.NAME ASC";
	public static final String ORDER_BY_SQL = " ORDER BY rivetlogic_DriveLinks.USER_ID ASC, rivetlogic_DriveLinks.NAME ASC";
