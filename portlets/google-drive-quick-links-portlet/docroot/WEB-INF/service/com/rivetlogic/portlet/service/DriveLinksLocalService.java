...
/**
 * Provides the local service interface for DriveLinks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author charlesrodriguez
 * @see DriveLinksLocalServiceUtil
...
public interface DriveLinksLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DriveLinksLocalServiceUtil} to access the drive links local service. Add custom service methods to {@link com.rivetlogic.portlet.service.impl.DriveLinksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
